-- Create database views for site-based statistics

-- Site work order statistics view
CREATE OR REPLACE VIEW site_work_order_stats AS
SELECT 
  wo.site_id,
  s.name AS site_name,
...
CREATE OR REPLACE VIEW site_revenue_stats AS
SELECT 
  wo.site_id,
  s.name AS site_name,
  o.name AS organization_name,
...
CREATE OR REPLACE VIEW site_productivity_stats AS
SELECT 
  wo.site_id,
  s.name AS site_name,
  o.name AS organization_name,
